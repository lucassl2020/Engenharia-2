...
class TelaListaVendas(QWidget):
    def __init__(self, parent=None):
        super(TelaListaVendas, self).__init__(parent)
    ...
    def _create_widgets(self):
        self.realizar_venda_label = label(self, "Vendas", 0, 0, 600, 60)
    ...
    def botaoVoltar(self):
        event = {"codigo": 34, "descricao": "Botão VOLTAR da tela LISTA VENDAS"}
