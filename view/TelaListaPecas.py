...
class TelaListaPecas(QWidget):
    def __init__(self, parent=None):
        super(TelaListaPecas, self).__init__(parent)
    ...
    def _settings(self):
        ...
        self.setWindowTitle("Peças")
 

    def _create_widgets(self):
        self.realizar_venda_label = label(self, "Peças", 0, 0, 600, 60)
    ...
    def botaoVoltar(self):
        event = {"codigo": 35, "descricao": "Botão VOLTAR da tela LISTA PECAS"}
